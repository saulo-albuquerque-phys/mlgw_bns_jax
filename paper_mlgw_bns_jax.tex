...
reduced-order quadrature (ROQ) basis using \texttt{JenpyROQ} and implement a
JAX-native ROQ likelihood that evaluates waveform templates only at
$\mathcal{O}(10^2)$ empirical interpolation nodes rather than the full
